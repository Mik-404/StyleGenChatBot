...
wrong_command_set_prob_to_bot = 'Вы не привильно обратились к боту. ' \
                      ...
                      'Пример: \n' \
                      '/set_prob @{} cute'.format(settings.BOT_NAME)
'''
...
help_massage = 'Привет, я могу изменять стиль твоих сообщений!\n'\
               ...
               ' А ещё я могу разговаривать как йода!\n'\
                ...
                'Узнать текущие настройки можно командой /status <имя бота>\n'\
                '/set_style <имя бота> изменяет значение по умолчанию вашего стиля\n'\
                '/set_prob <имя бота> изменяет вероятность ответа на случайное сообщение от 0 % до 100%\n' \
                'Пример команды:\n' \
